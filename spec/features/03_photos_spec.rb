...
describe "/photos" do
  it "has a form element", :points => 1 do
    ...
    photo = Photo.new
    photo.image = "https://robohash.org/undertale.png?size=300x300&set=set1"
...
describe "/photos" do
  it "has a label element with text 'Image'", :points => 1 do
    ...
    photo = Photo.new
    photo.image = "https://robohash.org/thelastofus.png?size=300x300&set=set1"
    photo.caption = "Some test caption #{Time.now.to_i}"
    photo.owner_id = busdriver.id
    photo.save
...
describe "/photos" do
  it "has a label element with text 'Caption'", :points => 1 do
    ...
    photo = Photo.new
    photo.image = "https://robohash.org/pokemongo.png?size=300x300&set=set1"
    photo.caption = "Some test caption #{Time.now.to_i}"
    photo.owner_id = busdriver.id
    photo.save
...
describe "/photos" do
  it "has a button element with text 'Add photo'", :points => 1 do
    ...
    photo = Photo.new
    photo.image = "https://robohash.org/celeste.png?size=300x300&set=set1"
    photo.caption = "Some test caption #{Time.now.to_i}"
    photo.owner_id = busdriver.id
    photo.save
...
describe "/photos" do
  it "has a form to add a new Photo if signed in", :points => 1 do
    ...
    photo = Photo.new
    photo.image = "https://robohash.org/transistor.png?size=300x300&set=set1"
    photo.caption = "Some test caption #{Time.now.to_i}"
    photo.owner_id = busdriver.id
    photo.save
